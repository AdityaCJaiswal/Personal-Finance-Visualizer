...
import { Plus, Wallet, TrendingUp, TrendingDown, Target, ArrowUpRight, ArrowDownRight, Calendar } from 'lucide-react';
...
export function Dashboard() {
  ...
  const [activeView, setActiveView] = useState<'dashboard' | 'analytics' | 'budgets'>('dashboard');
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12 max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">
            ...
            {activeView === 'budgets' && 'Budget Management'}
            <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
              {activeView === 'dashboard' && ' Overview'}
              {activeView === 'analytics' && ' Insights'}
              {activeView === 'budgets' && ' Center'}
            </span>
          </h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            {activeView === 'dashboard' && 'Track your income and expenses with beautiful visualizations and insights'}
            {activeView === 'analytics' && 'Analyze your spending patterns and financial trends'}
            {activeView === 'budgets' && 'Set and monitor your monthly spending budgets'}
          </p>
        </div>
