...
import { Wallet, DollarSign, PieChart, Target } from 'lucide-react';
import { Button } from '@/components/ui/button';

interface NavbarProps {
  activeView?: 'dashboard' | 'analytics' | 'budgets';
  onViewChange?: (view: 'dashboard' | 'analytics' | 'budgets') => void;
}
        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 -mt-1">Track, Analyze, Budget</p>
            </div>
          </div>
